...
%prep
%setup -q -n libqalculate-3.7.0
cd %{_builddir}/libqalculate-3.7.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579893895
...
cp %{_builddir}/libqalculate-3.7.0/COPYING %{buildroot}/usr/share/package-licenses/libqalculate/dfac199a7539a404407098a2541b9482279f690d
%make_install
...
/usr/lib64/libqalculate.so.21.6.0
