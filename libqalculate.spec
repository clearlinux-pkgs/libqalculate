...
Source0  : https://github.com/Qalculate/libqalculate/releases/download/v3.5.0/libqalculate-3.5.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1572461518
...
cp %{_builddir}/libqalculate-3.5.0/COPYING %{buildroot}/usr/share/package-licenses/libqalculate/dfac199a7539a404407098a2541b9482279f690d
%make_install
...
/usr/lib64/libqalculate.so.21.4.0
